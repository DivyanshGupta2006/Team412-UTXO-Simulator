...
def run_mainmenu():
    options = ['Create new transaction', 'View UTXO set', 'View mempool', 'Mine block', 'Run test scenarios', 'Exit']
    choice = display_menu(options, "Enter Choice: ", "===  Bitcoin Transaction Simulator ===", True)
    if choice == 1:
        pass
    elif choice == 2:
        pass
